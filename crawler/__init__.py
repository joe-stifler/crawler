...
def main():
    ...
    parser = argparse.ArgumentParser(description="Web Crawler for generating Markdown from web pages")
    parser.add_argument("url", type=str, help="The starting URL for the web crawl")
    parser.add_argument("output_folder", type=str, help="The folder where Markdown files will be saved")
    parser.add_argument("--merge", action="store_true", help="Merge all pages into a single Markdown file")
    parser.add_argument("--max_depth", type=int, default=1, help="Maximum depth to crawl from the starting URL")
